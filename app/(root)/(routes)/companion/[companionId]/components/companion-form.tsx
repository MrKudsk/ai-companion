...
export const CompanionForm = ({
  ...
  return (
    <div className="">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="h-full p-4 space-y-2 max-w-3xl mx-auto">
            ...
            name="description"
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormControl>
                    <Input disabled={isLoading} placeholder="CEO of Tesla, SpaceX, X" {...field} />
                  </FormControl>
                  <FormDescription>
